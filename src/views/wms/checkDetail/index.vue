  ...
  <div class="app-container">
    <div style="background-color: white;border-radius: 10px;" ref="top">
      ...
      margin-bottom: 15px;background: #f9f9f9;border-radius: 10px 10px 0px 0px;color: #00000091;" >
        ...
        <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px" style="padding-left: 10px;">
          ...
          <el-form-item label="账面数量" prop="curtainNum">
            <el-input
              v-model="queryParams.curtainNum"
              placeholder="请输入账面数量"
              clearable
              @keyup.enter.native="handleQuery"
            />
        ...
        <el-row :gutter="10" class="mb8">
          <el-col :span="1.5">
            <el-button
              ...
              size="mini"
              @click="handleAdd"
              v-hasPermi="['wms:checkAdjustDetail:add']"
            >新增</el-button>
          </el-col>
          <el-col :span="1.5">
            <el-button
              ...
              :disabled="multiple"
              @click="handleDelete"
              v-hasPermi="['wms:checkAdjustDetail:remove']"
            >删除</el-button>
          </el-col>
          <el-col :span="1.5">
            <el-button
              ...
              size="mini"
              @click="handleExport"
              v-hasPermi="['wms:checkAdjustDetail:export']"
            >导出</el-button>
          </el-col>
          <el-col :span="1.5">
            <el-button
                ...
                size="mini"
                @click="handleImport"
                v-hasPermi="['wms:checkAdjustDetail:import']"
            >导入</el-button>
          </el-col>
          <right-toolbar :showSearch.sync="showSearch" @queryTable="getList"></right-toolbar>
        </el-row>

        <el-table v-loading="loading" :data="checkDetailList" :height="tableHeight" @selection-change="handleSelectionChange">
          ...
          <el-table-column label="操作" align="center" width="200" fixed="right" class-name="small-padding fixed-width">
            <template slot-scope="scope">
              ...
              <el-button
                ...
                v-hasPermi="['wms:checkAdjustDetail:edit']"
              >修改</el-button>
              <el-button
                size="mini"
                type="text"
    ...
    <el-dialog :title="title" :visible.sync="open" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-col :span="24">
            <el-form-item label="盘点单号" prop="checkBillCode">
              <el-input v-model="form.checkBillCode" placeholder="请输入盘点单号" show-word-limit maxlength="255"/>
            </el-form-item>
        </el-col>
        <el-col :span="24">
            <el-form-item label="盘点货物编码" prop="goodsCode">
              <el-input v-model="form.goodsCode" placeholder="请输入盘点货物编码" show-word-limit maxlength="255"/>
            </el-form-item>
        </el-col>
        <el-col :span="24">
            <el-form-item label="盘点货物名称" prop="goodsName">
              <el-input v-model="form.goodsName" placeholder="请输入盘点货物名称" show-word-limit maxlength="255"/>
            </el-form-item>
        </el-col>
        <el-col :span="24">
            <el-form-item label="盘点库区编号" prop="areaCode">
              <el-input v-model="form.areaCode" placeholder="请输入盘点库区编号" show-word-limit maxlength="255"/>
            </el-form-item>
        </el-col>
        <el-col :span="24">
            <el-form-item label="盘点库区名称" prop="areaName">
              <el-input v-model="form.areaName" placeholder="请输入盘点库区名称" show-word-limit maxlength="255"/>
            </el-form-item>
        </el-col>
        <el-col :span="24">
        ...
        <el-col :span="24">
            <el-form-item label="盘点库位名称" prop="locationName">
              <el-input v-model="form.locationName" placeholder="请输入盘点库位名称" show-word-limit maxlength="255"/>
            </el-form-item>
        </el-col>
        <el-col :span="24">
        ...
        <el-col :span="24">
            <el-form-item label="账面数量" prop="curtainNum">
              <el-input v-model="form.curtainNum" placeholder="请输入账面数量" show-word-limit maxlength="50"/>
            </el-form-item>
        </el-col>
        <el-col :span="24">
            <el-form-item label="盘点数量" prop="checkNum">
              <el-input v-model="form.checkNum" placeholder="请输入盘点数量" show-word-limit maxlength="50"/>
            </el-form-item>
        </el-col>
        <el-col :span="24">
            <el-form-item label="盘亏数量" prop="lossNum">
        ...
        <el-col :span="24">
            <el-form-item label="盘盈数量" prop="profitNum">
              <el-input v-model="form.profitNum" placeholder="请输入盘盈数量" show-word-limit maxlength="50"/>
            </el-form-item>
        </el-col>
        <el-col :span="24">
    ...
    <el-dialog :title="title" :visible.sync="viewModalOpen" append-to-body>
        <el-descriptions :column="2" border>
          ...
          <el-descriptions-item label="盘点货物编码">{{ viewForm.goodsCode }}</el-descriptions-item>
          <el-descriptions-item label="盘点货物名称">{{ viewForm.goodsName }}</el-descriptions-item>
          <el-descriptions-item label="盘点库区编号">{{ viewForm.areaCode }}</el-descriptions-item>
          <el-descriptions-item label="盘点库区名称">{{ viewForm.areaName }}</el-descriptions-item>
          <el-descriptions-item label="盘点库位编号">{{ viewForm.locationCode }}</el-descriptions-item>
          <el-descriptions-item label="盘点库位名称">{{ viewForm.locationName }}</el-descriptions-item>
          <el-descriptions-item label="盘点托盘编号">{{ viewForm.trayCode }}</el-descriptions-item>
          <el-descriptions-item label="账面数量">{{ viewForm.curtainNum }}</el-descriptions-item>
          <el-descriptions-item label="盘点数量">{{ viewForm.checkNum }}</el-descriptions-item>
...
export default {
  ...
  data() {
    return {
      ...
      upload: {
        ...
        // 上传的地址
        url: process.env.VUE_APP_BASE_API + "/wms/checkDetail/importData"
      },
      viewForm:{},
      viewModalOpen:false,
      // 表单参数
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('wms/checkDetail/export', {
        ...this.queryParams
    ...
    /** 下载模板操作 */
    importTemplate() {
      this.download('wms/checkDetail/importTemplate', {
      }, `库存盘点调整单详情导入模板.xlsx`)
    },
    // 文件上传中处理
