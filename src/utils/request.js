/*
 * @Date: 2023-02-15 16:08:57
 * @Description:
 * @LastEditors: jun
 * @FilePath: \umbrella-wms-web\src\utils\request.js
 */
...
service.interceptors.response.use(res => {
    ...
    if (code === 401) {
    ...
    } else if (code === 601 && !url.includes('/wcs/freshAirDetailInfo/start?id=')) {
      ...
      return res.data
    } else if (code !== 200  && !url.includes('/wcs/freshAirDetailInfo/start?id=')) {
